...
public class Activity_Them_Danh_Muc extends AppCompatActivity {
    ImageView ivDanhMuc;
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        downloadUri.addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                String idDanhMuc = ref.push().getKey();
                                DanhMuc danhMuc = new DanhMuc(idDanhMuc,edtTenDanhMuc.getText().toString(),photoLink);
                                ref.child(danhMuc.getIdDanhMuc()).setValue(danhMuc, new DatabaseReference.CompletionListener() {
                                    @Override
                                    public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                                        Toast.makeText(Activity_Them_Danh_Muc.this, "Thêm danh mục thành công", Toast.LENGTH_SHORT).show();
                                        if(error==null)
                                        {
                                            finish();
                                        }
