...
public class RecyclerViewTouch extends ItemTouchHelper.SimpleCallback {
    ...
    public RecyclerViewTouch(int dragDirs, int swipeDirs, ItemTouchListenerHelper listenerHelper) {
    ...
    public void onSelectedChanged(@Nullable RecyclerView.ViewHolder viewHolder, int actionState) {
        if(viewHolder != null)
        {
            View layout = ((SanPhamAdapter.SanPhamViewHolder)viewHolder).layout;
